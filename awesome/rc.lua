...
rofi = "rofi -show drun"
power = "~/Documents/applets/pmenu.sh"
emoji = "~/Documents/applets/emoji.sh"
wallpaper = "~/Documents/applets/awesomewall.sh"
filemanager = "thunar"
browser = "firefox"
...
mytextclock = wibox.widget.textclock("%I:%M %A")
...
local function update_mem_widget()
	awful.spawn.easy_async_with_shell("free | awk '/Mem:/ {printf \"%d%%\", $3/$2 * 100}'", function(out)
		mem_widget:get_children_by_id("mem_text")[1]:set_text(out)
	end)
end
...
gears.timer({
	...
	call_now = true,
	autostart = true,
	callback = update_mem_widget,
})

-- Add click event to open htop in alacritty
mem_widget:buttons(awful.util.table.join(awful.button({}, 1, function()
